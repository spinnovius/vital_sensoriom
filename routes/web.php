...
Route::get('testing', 'Admin\AdminController@testing')->name('admin.testing');
...
Route::get('user/arrive/status/{id}', 'Admin_main\AdminmainController@arrivechangestatus')->name('user.arrive.status');
/*Admin Main*/
...
Route::get('panelists','Admin_main\AdminmainController@panelists')->name('admin_main.panelists');
...
//reappointment
Route::post('admin/patient/reappointment/{id}', 'Admin_main\AdminmainController@reappointment')->name('admin_main.reappointment');
Route::get('admin/patient/printappointment/{id}', 'Admin_main\AdminmainController@printappointment')->name('admin_main.printappointment');
//123456789

Route::get('admin/patient/pasthealthrecords/{id}', 'Admin_main\AdminmainController@past_health_records')->name('store_patient.pasthealthrecords');
Route::patch('admin/patient/update', 'Admin_main\AdminmainController@update')->name('store_patient.update');
Route::post('admin/patient/patientplanstore', 'Admin_main\AdminmainController@patient_plan_store')->name('store_patient.patient_plan_store');
...
Route::post('admin/patient_share_doctor','Admin_main\AdminmainController@patientsharedoctor2')->name('admin_main.patientsharedoctor');


Route::get('hospital/byCity/{city_id}', 'Admin_main\AdminmainController@hospitalByCity')->name('hostipal.bycity');
Route::get('clinic/byCity/{city_id}', 'Admin_main\AdminmainController@clinicByCity')->name('clinic.bycity');
Route::get('doctor/bySpeciality/{clinic}/{speciality_id}/{city_id}', 'Admin_main\AdminmainController@doctorclinicBySpeciality')->name('doctor.clinicbySpeciality');
...
Route::get('doctor/timeslot/{doctor_id}', 'Admin_main\AdminmainController@doctorBytimeslot')->name('doctor.timeslot');
Route::get('patient/datesearchtask/{doctorid}/{date}', 'Admin_main\AdminmainController@datesearchtask')->name('patient.datesearchtask');
...
//Examination
Route::get('/patient/{id}/ex', 'Admin_main\AdminmainController@indexExamination')->name('admin_main.exindex');
//General Examination
...
//CLINICAL MANAGEMENT
Route::get('/patient/{id}/clinicalmanagement', 'Admin_main\AdminmainController@indexClinicalManagement')->name(
	'admin_main.clinical_managementindex');
Route::post('/patient/{society_id}/clinicalmanagement/store', 'Admin_main\AdminmainController@StoreClinicalManagement')->name('admin_main.clinicalmanagementstore');
Route::post('medicines', 'Admin_main\AdminmainController@medicinesList')->name('admin_main.medicinesList');
...
Route::get('/patientvitals/{id}/patientvitals', 'Admin_main\AdminmainController@indexvitalslabtest')->name('admin_main.indexvitalslabtest');
...
Route::get('openreadlinkupcoming/{appointment_id}','Admin_main\AdminmainController@openreadlinkupcoming')->name('admin_main.upcomingappointment.openreadlinkupcoming');
...
Route::get('referral','Admin_main\AdminmainController@referral')->name('admin_main.referral');
Route::get('openreadlinkreferral/{appointment_id}','Admin_main\AdminmainController@openreadlinkreferral')->name('admin_main.upcomingappointment.openreadlinkreferral');
...
Route::get('openreadlinkpointofcare/{appointment_id}','Admin_main\AdminmainController@openreadlinkpointofcare')->name('admin_main.upcomingappointment.openreadlinkpointofcare');

Route::get('appointment/
	/{id}/{status}', 'Admin_main\AdminmainController@apporverejectappointments')->name('admin_main.apporve');
...
//time slot hour
Route::post('doctor/settings/{id}', 'Admin_main\AdminmainController@storedoctorsettings')->name('admin_main.storedoctorsettings');
Route::patch('doctor/settings/{id}', 'Admin_main\AdminmainController@editdoctorsettings')->name('admin_main.editdoctorsettings');
Route::get('doctor/dayssearchtask/{doctorid}', 'Admin_main\AdminmainController@dayssearchtask')->name('doctor.dayssearchtask');//123456789
...
Route::post('post/panalist/referanswer','Admin_main\AdminmainController@answerreferpanalistpatient')->name('poc.referanswer.patient');


Route::get('dr/drreplay/{id}', 'Admin_main\AdminmainController@DoctorReplay')->name('admin_main.doctor.DoctorReplay');
Route::patch('dr/update', 'Admin_main\AdminmainController@updatedrreplay')->name('dr.update');

Route::get('answer/{id}', 'Admin_main\AdminmainController@Answer')->name('admin_main.answer');

Route::get('dranswer/{id}', 'Admin_main\AdminmainController@DrAnswer')->name('admin_main.dranswer');
Route::get('panelanswer/{id}', 'Admin_main\AdminmainController@PanelAnswer')->name('admin_main.panelanswer');


Route::get('panel/panelreply/{id}', 'Admin_main\AdminmainController@panelreply')->name('admin_main.panel.panelreply');
Route::patch('panel/update', 'Admin_main\AdminmainController@updatepanelreplay')->name('panel.update');

Route::get('drforms/{id}', 'Admin_main\AdminmainController@patientexaminationrecords')->name('admin_main.drforms');
...
Route::get('admin/payment/refundrequest', 'Admin\PaymentController@refundrequest')->name('admin.payment.refund');

Route::get('admin/payment/list', 'Admin\PaymentController@index')->name('admin.payment');

Route::get('admin/payment/refund/{call_history_id}/{status}', 'Admin\PaymentController@refund')->name('payment.refund');
Route::get('admin/ajax/paymentarray', 'Admin\PaymentController@paymentarray')->name('admin.ajax.paymentarray');
Route::get('admin/ajax/paymentrefundarray', 'Admin\PaymentController@paymentrefundarray')->name('admin.ajax.paymentrefundarray');
...
Route::get('admin/medicine/add_new', 'Admin\SpecialityController@addmedines_new')->name('medicines.new');
Route::get('admin/medicine/medinesuploadfile', 'Admin\SpecialityController@medinesuploadfilepage')->name('medicines.medinesuploadfilepage');
Route::post('admin/medicine/medinesuploadfile', 'Admin\SpecialityController@medinesuploadfile')->name('medicines.medinesuploadfile');
Route::get('admin/medicines/ajax/specialityarray', 'Admin\SpecialityController@medicinesarray')->name('medicines.ajax.medicinesarray');
Route::post('admin/medicines/store', 'Admin\SpecialityController@storemedicines')->name('medicines.store');
Route::get('admin/medicines/edit/{id}', 'Admin\SpecialityController@editmedicines')->name('medicines.edit');
Route::patch('admin/medicines/update', 'Admin\SpecialityController@medicineupdate')->name('medicines.update');
Route::get('admin/medicines/verified/{id}/{status}', 'Admin\SpecialityController@medicineverified')->name('medicines.verified');
Route::get('admin/medicines/delete/{id}', 'Admin\SpecialityController@medicinedelete')->name('medicines.delete');
