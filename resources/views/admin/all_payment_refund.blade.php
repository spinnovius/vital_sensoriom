...
<section class="content-header">
    <h1>Payment Refund Request</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}"><i class="fa fa-dashboard"></i>Home</a></li>
        <!--<li class=""><a href="{{ route('poc.add_poc') }}">Payment</a></li>-->
        <li class="active">Payment Refund Request</li>
    </ol>
</section>
...
<script>
    $(document).ready(function () {
        ...
        var userdatatable = $('#userdatatable').DataTable({
            ...
            responsive: true,
            "processing": true,
            "ajax": "{{ route('admin.ajax.paymentrefundarray') }}",
            "language": {
                "emptyTable": "No Payment Refund Request available"
            },
            "order": [[0, "desc"]],
        });
