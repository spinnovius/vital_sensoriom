<form action="{{ route('admin_main.gestore',$patient_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-6 md-6">
                            <label class="" for="Radial Artery">Local Examination Notes</label>
                        </div>
                        <div class="col-md-4 md-4">
                            <input type="text" name="local_examination" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-6 md-6">
                            <label class="" for="Special Notes">Special Notes</label>
                        </div>
                        <div class="col-md-4 md-4">
                            <input type="text" name="special_note" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
