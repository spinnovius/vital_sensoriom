...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="#">My Care Coach faq</a></li>
    </ol>
</section>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            <div class="box box-info">
                ...
                @endif
                    ...
                    @if(isset($coachfaq))
                    <form class="form-horizontal" action="{{ route('coachfaq.update')}}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_method" value="PATCH">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" value="{{ $coachfaq[0]['id'] }}" name="id" />
                    @else
                    <form class="form-horizontal" action="{{ route('coachfaq.store')}}" method="post" enctype="multipart/form-data">
                    @endif
                    ...
                    <div class="box-body">
                        <div class="col-md-12">                            
                            <div class="form-group">
                                ...
                                @if(isset($coachfaq))
                                <input type="text" name="question" class="form-control" value="{{ $coachfaq[0]['question'] }}"/>
                                @else
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($coachfaq))
                                <textarea id="editor1" type="text" name="answer" class="form-control" >{{ @$coachfaq[0]['answer'] }}</textarea>
                                @else
...
<script>
    $(document).ready(function () {
        ...
        var userdatatable = $('#userdatatable2').DataTable({
            ...
            responsive: true,
            "processing": true,
            "ajax": "{{ route('coachfaq.ajax.faqarray') }}",
            "language": {
