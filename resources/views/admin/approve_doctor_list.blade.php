...
<section class="content-header">
    <h1>Approve Doctor List</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}"><i class="fa fa-dashboard"></i>Home</a></li>
        <li class="active">Approve Doctor List</li>
    </ol>
</section>
...
<section class="content">
  ...
  <div class="modal fade" id="myModal1" role="dialog">
    <div class="modal-dialog">
     <form  action="{{ route('doctor.sendnotification')}}" method="post">
...
<script>
    ...
    function doctor_notification(id)
    {
        $('#user_id').val(id);
    }
    ...
    $(document).ready(function () {
        ...
        var userdatatable = $('#userdatatable').DataTable({
            ...
            responsive: true,
            "processing": true,
            "ajax": "{{ route('approvedoctor.ajax.approvedoctorarray') }}",
            "language": {
                "emptyTable": "No Approve doctor available"
            },
            "order": [[0, "desc"]],
        });
