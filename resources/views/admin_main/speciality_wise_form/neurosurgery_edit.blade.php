<form action="{{ route('admin_main.geupdate',[$patient_id, $patientge->id])}}" method="post" enctype="multipart/form-data">
                    ...
                    <h3 class="card-title text-uppercase"><b>Neuro Surgery Specific Examination:</b></h3>
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-4 mb-4">
                            <input type="text" name="comascale" placeholder="Glasgow Coma Scale" value="{{$PatientGeNew->comascale}}" class="form-control" >
                        </div>
                    </div>
