            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="table-responsive">
                        <table id="userdatatable" class="table table-bordered table-hover display" width="100%">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Lab Test Name</th>
...
<script>
    $(document).ready(function () {
        ...
        var url = '{{ route("clinic.patientlabtestarray", ":id") }}';
        ...
        var userdatatable = $('#userdatatable').DataTable({
            ...
            "language": {
                "emptyTable": "No Labtest available"
            },
            "order": [[0, "desc"]],
        });
