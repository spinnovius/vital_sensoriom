                    ...
                    <div class="box-body">
                        <div class="col-md-6">                            
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($admin))
                                <input type="number" name="contact_number" class="form-control" value="{{ $admin[0]['contact_number'] }}"/>
                                @else
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="role">
                                    ...
                                    <?php foreach ($role as $r) { ?>
                                        <option @if(@$admin[0]['role_id'] == $r['id']) selected="selected" @endif  value="<?php echo $r['id'];?>"><?php echo $r['role'];?></option>
                                    <?php } ?>
                                </select>
                            </div>
