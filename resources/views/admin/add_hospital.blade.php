                ...
                @endif
                    ...
                    <div class="box-body">
                        <div class="col-md-6">                            
                            ...
                            <div class="form-group">
                                <label class="control-label">Urgent Care Number <span class="text-danger">*</span></label>
                                @if(isset($hospital))
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="city">
                                    ...
                                    @foreach($city as $c)
                                    <option <?php if($hospital[0]['city'] == $c['id']){ ?> selected="selected" <?php } ?> value="{{ $c['id'] }}">{{ $c['city'] }}</option>
                                    @endforeach
                                </select>
                                @else
                                <select class="form-control" name="city">
