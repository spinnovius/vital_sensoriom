...
<section class="content-header">
    <h1>Pending Coach List</h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}"><i class="fa fa-dashboard"></i>Home</a></li>
        <li class="active">Pending Coach List</li>
    </ol>
</section>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var userdatatable = $('#userdatatable').DataTable({
            ...
            responsive: true,
            "processing": true,
            "ajax": "{{ route('pendingcoach.ajax.pendingcoacharray') }}",
            "language": {
                "emptyTable": "No Pending coach available"
            },
            "order": [[0, "desc"]],
        });
