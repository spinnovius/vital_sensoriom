<form action="{{ route('admin_main.gestore',$patient_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="local_examimation" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="ulcers_exam" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
