                        ...
                        <tbody>  
                          @foreach($PatientDetail as $vitals)
                                <tr>
                                    @if(session('role')==2)
                                    <td>
                                        <a class="colorname" href="{{route('admin_main.upcomingappointment.openreadlinkupcoming', $vitals->id)}}">{{$vitals->patientname}}</a>
                                    </td>
                                    @else
                                    ...
                                    @if(session('role')==2)
                                    <td><label style="cursor: pointer;" class="label btnclk {{ ($vitals->arrives == 0) ? 'label-success' : 'label-dark' }}">{{ ($vitals->arrives == 0) ? 'Arrived' : 'NotArrived' }}</label></td>
                                    @else
                                    ...
                                    <td>
                                        ...
                                        @endif
                                        <a class="colorname" href="{{route('store_patient.edit', $vitals->patient_id)}}"><i class="fa fa-pencil"></i></a></td>
                                    @endif
                                </tr>
                         @endforeach   
                        </tbody>
