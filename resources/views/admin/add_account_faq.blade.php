...
<section class="content-header">
    <h1>My Account <small>Payment & Security</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            <div class="box box-info">
                ...
                @endif
                    ...
                    @if(isset($accountfaq))
                    <form class="form-horizontal" action="{{ route('accountfaq.update')}}" method="post" enctype="multipart/form-data">
                    <input type="hidden" name="_method" value="PATCH">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" value="{{ $accountfaq[0]['id'] }}" name="id" />
                    @else
                    <form class="form-horizontal" action="{{ route('accountfaq.store')}}" method="post" enctype="multipart/form-data">
                    @endif
                    ...
                    <div class="box-body">
                        <div class="col-md-12">                            
                            <div class="form-group">
                                ...
                                @if(isset($accountfaq))
                                <input type="text" name="question" class="form-control" value="{{ $accountfaq[0]['question'] }}"/>
                                @else
                            ...
                            <div class="form-group">
                                ...
                                @if(isset($accountfaq))
                                <textarea id="editor1" type="text" name="answer" class="form-control" >{{ @$accountfaq[0]['answer'] }}</textarea>
                                @else
...
<script>
    $(document).ready(function () {
        ...
        var userdatatable = $('#userdatatable2').DataTable({
            ...
            responsive: true,
            "processing": true,
            "ajax": "{{ route('accountfaq.ajax.faqarray') }}",
            "language": {
