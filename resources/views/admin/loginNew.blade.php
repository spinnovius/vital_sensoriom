                ...
                <form class="login-form" method='post' action="{{ route('admin.login')}}">
                    ...
                    <div class="form-inputs">
                        <div class="login-logo">
                            <a href=""><b><img class="adm-log-logo" style="width:50%;height:auto" src="{{ asset('public/bootstrap_startup/images/logo.png')}}"></b></a>
                        </div>
                    ...
                    <div class="form-group">
                        <center><a class="text-center btn btn-link" style="margin-top: 5%;"></a></center>
                    </div>
                </form>
            </div>
        </div>    
