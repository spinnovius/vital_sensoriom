        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
            ...
            <div class="box box-info">
                ...
                @endif
                    ...
                    <input type="hidden" value="{{ $unit[0]['id'] }}" name="id" />
                    @else
                    ...
                    <div class="box-body">
                        <div class="col-md-6">                            
                            <div class="form-group">
                                ...
                                @if(isset($unit))
                                <input type="text" name="unit" class="form-control" value="{{ $unit[0]['unit'] }}"/>
                                @else
...
<script>
    $(document).ready(function () {
        ...
        var userdatatable = $('#userdatatable2').DataTable({
            ...
            responsive: true,
            "processing": true,
            "ajax": "{{ route('unit.ajax.unitarray') }}",
            "language": {
                "emptyTable": "No Helth Problem available"
            },
            "order": [[0, "desc"]],
        });
