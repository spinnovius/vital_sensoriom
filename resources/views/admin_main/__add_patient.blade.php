...
<div class="col-md-12">
  <!-- <div class="container"> -->
      ...
      <form action="{{ route('admin_main.store_patient')}}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-row">
          <div class="col-md-3 mb-3">
            @if(isset($PatientDetail))
            <input type="text" class="form-control" id="validationDefault01" placeholder="NAME"  required name="name" value="{{$PatientDetail['fname']}}" @if(session('role')==2 || session('role')==6) disabled @endif>
            @else
          ...
          <div class="col-md-2 mb-3">
            @if(isset($PatientDetail))
            <input type="text" class="form-control dobDMYpicker" id="validationDefault02" placeholder="Date Of Birth" required name="age" value="{{date("d-m-Y", strtotime($PatientDetail['dob']))}}" maxlength="3" autocomplete="off" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" @if(session('role')==2 || session('role')==6) disabled @endif >
            @else
          ...
          <div class="col-md-4 mb-3">
            <div class="input-group">
              @if(isset($PatientDetail))
              <select class="form-control" name="gender" required="" @if(session('role')==2 || session('role')==6) disabled @endif style="width:125px;">
        ...
        <div class="form-row">
          @if(isset($PatientDetail))
          <div class="col-md-5 mb-3">
            <input type="file" class="form-control" id="validationDefault03"name="profile" @if(session('role')==2 || session('role')==6) disabled @endif>
      ...
      <div class="form-row">
          ...
          <div class="form-row">
            ...
            <div class="form-row">
              ...
              <a class="btn btn-primary btn-info" href="{{route('admin_main.printappointment', $PatientDetail->id)}}"><i class="fa fa-file-pdf-o" aria-hidden="true"></i> Print</a>
              </div>
            </div>
      ...
      @if(isset($PatientDetail))
          ...
          <div class="col-md-4 mb-3">
            <select class="form-control" name="plan_id" required="">
              ...
              <option <?php if(old('health_plan') == $plan->id ){ ?> selected="selected" <?php } ?> value="{{ $plan->id }}">
    ...
    @if(isset($PatientDetail))
    @if(session('role')==5)
    <h3 class="card-title text-uppercase"><b> New Appointment Details</b></h3>
    <form class="form-inline" action="{{ route('admin_main.reappointment',$PatientDetail->id)}}" method="post" enctype="multipart/form-data" style="margin-top: -4px;">
      @csrf
      <div class="form-group m-1">
        <input type="text" class="form-control singleDMYdate" name="date" placeholder="Date" autocomplete="off" required="">
      </div>
