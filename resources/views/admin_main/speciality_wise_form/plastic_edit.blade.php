<form action="{{ route('admin_main.geupdate',[$patient_id, $patientge->id])}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="local_examination" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->localexamination}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="special_note" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->special_notes}}">
                        </div>
                    </div>
