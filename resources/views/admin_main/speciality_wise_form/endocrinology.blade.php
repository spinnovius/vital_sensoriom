<form action="{{ route('admin_main.gestore',$patient_id)}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="built" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="hair" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="eye" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="ear" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-6 md-6">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="mid" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-6 md-6">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="lip" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-6 md-6">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="dental" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-6 md-6">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="tongue" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    <div class="form-row" style="margin-bottom: 1em;">
                        <div class="col-md-6 md-6">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="neck" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="podiatric" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="vascular" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="thyroid" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="external_gene" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="sexual" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="systemic" placeholder="Enter value" class="form-control">
                        </div>
                    </div>
