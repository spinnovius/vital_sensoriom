<form action="{{ route('admin_main.geupdate',[$patient_id, $patientge->id])}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="general_appearance" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->general_apperance}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="reflexes" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->reflexs}}">
                        </div>
                    </div>
