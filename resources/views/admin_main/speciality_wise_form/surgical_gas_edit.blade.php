<form action="{{ route('admin_main.geupdate',[$patient_id, $patientge->id])}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="relevant_positive" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->relevant_inspection}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="relevant_palpation" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->relevant_palpation}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="relevant_auscultation" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->auscultation}}">
                        </div>
                    </div>
                    ...
                    <div class="form-row" style="margin-bottom: 1em;">
                        ...
                        <div class="col-md-4 md-4">
                            <input type="text" name="relevant_external" placeholder="Enter value" class="form-control" value="{{$PatientGeNew->relevant_genitalia}}">
                        </div>
                    </div>
