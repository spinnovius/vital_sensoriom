...
<section class="content-header" style="padding-bottom: 1em;">
        <h3 style="margin-left: 22px;">Add Prescription</h3>
</section>
<div class="col-sm-10">
<div class="container">
                @if ($errors->any())
                ...
                <form action="{{ route('admin_main.ppstore',$patient_id)}}" method="post" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-row">
                        <div class="col-md-4 mb-3">  
                          <input type="text" class="form-control" name="drugname" placeholder="Drug Name" value="{{old('date')}}" autocomplete="off" required>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                          <input type="text" class="form-control isnumbertype" maxlength="5" id="validationDefault01" placeholder="Dose" required name="dose" value="{{old('labtestname')}}">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-4 mb-3">  
